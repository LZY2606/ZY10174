...
type Parser struct {
	...
	// be set by passing a *DupKeyOptions as a parse argument.
	DupKey *DupKeyOptions
}
...
func (p *Parser) Parse(buf []byte, args ...any) (Node, error) {
	...
	p.dupFirst = p.DupKey != nil && p.DupKey.Mode == DupKeyFirst
	if p.stack == nil {
